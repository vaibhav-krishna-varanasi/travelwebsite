...
while(rs1.next())
{
		...
		st2.executeUpdate( "insert into account_travel_history values('"+userid+"',  '"+rs1.getString("Air_miles")+"','"+rs1.getString("Airline_Name")+"','"+rs1.getString("Source")+"'  ,'"+rs1.getString("Destination")+"','"+rs1.getString("Departure_Date")+"','new') ");
...
response.sendRedirect("fbook3.jsp?cost="+t_c+"&&red="+red);
}
